...
char e = 254, sound = 7, head = '$', body = '*', inputBuffer[BUFFER_SIZE], Map[n][n], *bufferFront = inputBuffer;
short headPos[2] = {0, 0}, tailPos[2] = {0, 0}, bufferedInput = 0, inputIndex = 0, length = 3, turns[n * n][4], (*turnsFront)[4] = turns, turnIndex = 0;
...
void updatePosition(short hDir[2], short tDir[2])
{
...
void changeDirection(const char &input ,const char &previousInput, short headDir[2])
{
...
int main()
{
    ...
    char input = *bufferFront, previousInput = *bufferFront;
    ...
    while (true)
    {
        ...
        if (bufferedInput > 0)
        {
            ...
            changeDirection(input,previousInput,headDir);
        }
        updatePosition(headDir, tailDir);
